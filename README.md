To view the website, download the Full-Code.zip file from Classroom. Open the .zip archive, then open the index.html file. It should open a copy of the website in your defauly browser.
